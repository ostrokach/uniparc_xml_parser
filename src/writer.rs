...
pub fn initialize_outputs(basedir: PathBuf) -> OutputBuffers<BufWriter<File>> {
    ...
    OutputBuffers {
        ...
        uniparc_xref: create_outfile("xref.tsv"),
        uniparc_xref2ncbi_gi: create_outfile("xref_ncbi_gi.tsv"),
        uniparc_xref2ncbi_taxonomy_id: create_outfile("xref_ncbi_taxonomy_id.tsv"),
        uniparc_xref2protein_name: create_outfile("xref_protein_name.tsv"),
        uniparc_xref2gene_name: create_outfile("xref_gene_name.tsv"),
        uniparc_xref2chain: create_outfile("xref_chain.tsv"),
        uniparc_xref2uniprot_kb_accession: create_outfile("xref_kb_accession.tsv"),
        uniparc_xref2proteome_id: create_outfile("xref_proteome_id.tsv"),
        uniparc_xref2component: create_outfile("xref_component.tsv"),
        ...
        uniprot_kb_accession: create_outfile("kb_accession.tsv"),
        proteome_id: create_outfile("proteome_id.tsv"),
        component: create_outfile("component.tsv"),
        uniparc_domain: create_outfile("domain.tsv"),
    }
}
